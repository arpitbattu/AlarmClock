        ...
        GoogleMap.OnMarkerDragListener
{
    ...
    public String duration, distance;
    ...
    private String getDirectionsUrl()
    {
        ...
        googleDirectionsUrl.append("&key="+"AIzaSyCGCKFAzPiIDGhyniiKT1wu5G-6ygDqtq8");
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace)
    {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyCGCKFAzPiIDGhyniiKT1wu5G-6ygDqtq8");
